...
At Company, we design every itinerary around these principles. We obsess over the quiet moments between the landmarks — the tea house halfway up a mountain, the family kitchen where you'll learn to cook a dish that's been in their family for centuries, the off-schedule detour to a village festival that wasn't in any guidebook.
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative h-[50vh] overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-8 pt-24 max-w-4xl mx-auto">
          ...
          <h1 className="font-display text-3xl md:text-5xl font-bold text-white mt-2 leading-tight">
            {post.title}
          </h1>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="mt-12 bg-brand-50 rounded-2xl p-8 text-center border border-brand-100">
          ...
          <p className="text-slate-500 mb-6">
            Browse our curated trips and find your perfect adventure.
          </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              {related.map((p) => (
                ...
                >
                  ...
                  <h3 className="font-semibold text-sm text-dark-800 group-hover:text-brand-600 transition-colors leading-snug">
                    {p.title}
                  </h3>
