...
const values = [
  {
    icon: Globe,
    title: "Global Reach",
    desc: "Deep partnerships across 150+ destinations mean you get authentic local experiences that mass-market operators simply cannot offer.",
  },
  {
    icon: Heart,
    title: "Passion-led",
    desc: "Every member of our team is a passionate traveler. We only recommend experiences we have personally vetted and loved.",
  },
  {
    icon: Shield,
    title: "Trust & Safety",
    desc: "Your safety and peace of mind are our priority. Comprehensive insurance partnerships and 24/7 emergency support.",
  },
  {
    icon: Award,
    title: "Award-winning",
    desc: "Recognized as Asia's Best Boutique Tour Operator for three consecutive years by the Travel Industry Association.",
  },
];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="mt-4 text-slate-600 leading-relaxed">
                ...
                we have grown into a team of 60+ specialists servicing travelers
                from 45 countries. Our philosophy has never changed: every trip
                we build should leave you different than when you arrived.
              </p>
              <p className="mt-4 text-slate-600 leading-relaxed">
                We are not a booking platform. We are travel architects —
                building tailored, end-to-end experiences with the precision of
                craftspeople and the enthusiasm of lifelong explorers.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-12">
            {values.map(({ icon: Icon, title, desc }) => (
              <div
                key={title}
                className="bg-white rounded-2xl p-6 border border-slate-100 hover:shadow-lg transition-all duration-300 hover:-translate-y-1"
              >
